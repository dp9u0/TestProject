...
namespace EmitLearn {
    ...
    public class IL_006 {
        ...
        public static void Run() {
            ...
            //4. 定义属性和字段
            //4.1字段 FieldBuilder
            FieldBuilder fieldABuilder = typeBldr.DefineField("numA", typeof (Int32), FieldAttributes.Private);
            //fieldABuilder.SetConstant(0); 此处为副初始值, 这里可省略

            FieldBuilder fieldBBuilder = typeBldr.DefineField("numB", typeof (Int32), FieldAttributes.Private);

            //5.定义属性numA的get;set;方法
            PropertyBuilder propertyABuilder = typeBldr.DefineProperty("NumA", PropertyAttributes.None, typeof (Int32),
                null);
            ...
            PropertyBuilder propertyBBuilder = typeBldr.DefineProperty("NumB", PropertyAttributes.None, typeof (Int32),
                null);
            ...
            ConstructorBuilder constructorBuilder =
                typeBldr.DefineConstructor(MethodAttributes.Public | MethodAttributes.HideBySig,
                    CallingConventions.HasThis, new Type[] {
            ...
            MethodBuilder calcMethodBuilder = typeBldr.DefineMethod("Calc",
                MethodAttributes.Public | MethodAttributes.HideBySig, typeof (Int32), Type.EmptyTypes);
